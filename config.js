...
const DROPS = {
  ...
  FAKE:     { bg: "#e0cffc", border: "#7952b3", symbol: "",   name: "虚偽", power: 0, penaltyDamage: 5 },
...
const JOBS = [
  { id: "citizen", name: "市民", icons: ["🧑‍💼", "👨‍💼", "👩‍🍳", "🧑‍🌾", "🧑‍🎨"], desc: "市民の連帯: 人数増加で全体効果加算。" },
  { id: "lawyer", name: "弁護士", icons: ["👩‍⚖️", "👨‍⚖️"], desc: "社会正義の実現: 毎ターン非開示・虚偽を1マス解除。" },
  { id: "reporter", name: "記者", icons: ["🕵️", "🕵️‍♂️"], desc: "報道の自由: 「報道」4マス以上消去で「疑問」を「署名/デモ」へ変換。" },
